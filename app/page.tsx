...
const projects = [
  ...
  },
  {
    ...
    description:
         "A multi-source RAG pipeline unifying SEC filings, earnings transcripts, and macroeconomic indicators into a time-aligned Medallion architecture. It enables analysts to instantly cross-reference official filings against unscripted executive sentiment and market data, served via a Mosaic AI Agent and instrumented with MLflow for end-to-end observability.",
